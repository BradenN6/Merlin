...
for column in luminosity_agg_columns:
    plt.plot(df.current_redshift, df[column]*1e-37, label=column)
    #plt.title(column)   

plt.xlabel("Redshift z")
plt.ylabel(r'Carbon Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Oxygen Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Nitrogen Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Magnesium Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Hydrogen Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Sulfur Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
...
plt.xlabel("Redshift z")
plt.ylabel(r'Helium Line Luminosities [erg s$^{-1}$]')
plt.grid(True)
plt.tight_layout()
plt.legend()
