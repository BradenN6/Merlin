...
path = '/Users/bnowicki/Research/Ricotti/fs035_ms10-analysis/infofile-dir/'
...
simpost = merlin_spectra.SimulationPostAnalysis('fs035_ms10', path, lines)
...
df_path = os.path.join(os.getcwd(), "fs035_ms10_post_analysis/analysis_data.csv")
